...
import 'package:tanyadokter_dokter/features/chat/bloc/chat_event.dart';
import 'package:tanyadokter_dokter/features/chat/bloc/chat_state.dart';
import 'package:tanyadokter_dokter/features/chat/views/widget/exit_chat_dialog.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: InkWell(
          onTap: () {
            showDialog(
                context: context, builder: (context) => const ExitChatDialog());
          },
          child: Padding(
